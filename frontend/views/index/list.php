				...
				<ul>
					...
					<li>
						<dl>
							...
							<dd><a href="<?=\yii\helpers\Url::to(['goods/detail','id'=>$good->id])?>"><?=$good->name?></a></dt>
							<dd><strong>￥<?=$good->shop_price?></strong></dt>
							<dd><a href="<?=\yii\helpers\Url::to(['goods/detail','id'=>$good->id])?>"><em>已有<?=rand(0,99999)?>人评价</em></a></dt>
						</dl>
					</li>
<?php endforeach;?>
