			...
			<div class="summary">
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?=date('Ymd H:i:s',$good->create_at)?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有<?=rand(0,9999)?>人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
