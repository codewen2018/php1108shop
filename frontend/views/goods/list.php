...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        <tr data-id="<?=$good->id?>">
            <td class="col1"><a href="<?=\yii\helpers\Url::to(['goods/detail','id'=>$good->id])?>"><img src="<?=$good->logo?>" alt="" /></a>  <strong>
                    <a href="<?=\yii\helpers\Url::to(['goods/detail','id'=>$good->id])?>"><?=$good->name?></a>
